...
public class Timelinetiga : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Nonaktifkan objek ondel di awal
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            // Aktifkan post-jumpscare trigger
            ActivateJumpscareTrigger();
    ...
    {
        // Aktifkan post-jumpscare trigger untuk memicu jumpscare setelah reward muncul
        if (postJumpscareTrigger != null)
        {
            postJumpscareTrigger.enabled = true;
        }
    }
}
